...
insert into student(stid,stname,dob,class,addr,country,contactno) values(101,'Sudarshan','2000-12-20',10,'Solapur','India','75498952345');
insert into student(stid,stname,dob,class,addr,country,contactno) values(102,'RK','2001-01-01',7,'Sydney','Australia','8945678723');
insert into student(stid,stname,dob,class,addr,country,contactno) values(103,'AC','2001-02-10',8,'Perth','Australia','9456023478');
insert into student(stid,stname,dob,class,addr,country,contactno) values(104,'LK','2004-12-21',7,'Tokyo','Japan','9823567998');
insert into student(stid,stname,dob,class,addr,country,contactno) values(105,'Vijay','2002-06-15',9,'Beijing','China','8834560175');
insert into student(stid,stname,dob,class,addr,country,contactno) values(106,'RL','2003-05-30',4,'Darwin ','Australia','7268935602');
insert into student(stid,stname,dob,class,addr,country,contactno) values(107,'Laxmikant','2002-03-23',9,'Pune','India','9028765129');
insert into student(stid,stname,dob,class,addr,country,contactno) values(108,'Pujari','2001-10-28',6,'Nashik','India','9594433677');
insert into student(stid,stname,dob,class,addr,country,contactno) values(109,'Ritik','2004-12-05',7,'New York','US','8855223399');
insert into student(stid,stname,dob,class,addr,country,contactno) values(110,'Sachin','2001-02-28',9,'Chicago','US','7772390865');
select * from student;
